...
def test_thall2014_efftox():
    ...
    assert np.all(np.abs(et.utility - np.array([-0.93, -0.62, 0.11, 0.46, 0.53])) <= epsilon2)
    ...
    assert np.all(np.abs(et.prob_tox - np.array([0.02, 0.06, 0.41, 0.77, 0.87])) <= epsilon2)
    ...
    assert np.all(np.abs(et.utility - np.array([-0.92, -0.63, -0.24, -0.41, -0.47])) <= epsilon2)
    ...
    assert np.all(np.abs(et.prob_acc_eff - np.array([0.01, 0.07, 0.84, 0.97, 0.98])) <= epsilon2)
...
def test_matchpoint_efftox():
    ...
    assert np.all(np.abs(et.utility - np.array([-0.48, -0.50, -0.57, -0.68])) <= epsilon2)
...
def test_thall2014_efftox_v2():
    ...
    next_dose = et.update(cases, n=10**6)
    assert next_dose == 1
    assert np.all(np.abs(et.prob_eff - np.array([0.16, 0.18, 0.26, 0.40, 0.51])) <= epsilon2)
    ...
    assert np.all(np.abs(et.prob_tox - np.array([0.07, 0.10, 0.26, 0.58, 0.79])) <= epsilon2)
    ...
    assert np.all(np.abs(et.utility - np.array([-0.78, -0.80, -0.88, -1.10, -1.18])) <= epsilon2)
    ...
    assert np.all(np.abs(et.prob_acc_eff - np.array([ 0.14, 0.13, 0.19, 0.37, 0.52])) <= epsilon2)
    ...
    assert np.all(np.abs(et.prob_acc_tox - np.array([0.92, 0.89, 0.68, 0.26, 0.09])) <= epsilon2)
    ...
    next_dose = et.update(cases, n=10**6)
    assert next_dose == 1
    assert np.all(np.abs(et.prob_eff - np.array([0.08, 0.10, 0.20, 0.37, 0.52])) <= epsilon1)
    ...
    assert np.all(np.abs(et.prob_tox - np.array([0.02, 0.05, 0.21, 0.56, 0.79])) <= epsilon1)
    ...
    assert np.all(np.abs(et.utility - np.array([-0.88, -0.88, -0.93, -1.13, -1.18])) <= epsilon2)
    ...
    assert np.all(np.abs(et.prob_acc_eff - np.array([ 0.05, 0.04, 0.11, 0.33, 0.52])) <= epsilon2)
    ...
    assert np.all(np.abs(et.prob_acc_tox - np.array([0.97, 0.95, 0.74, 0.27, 0.10])) <= epsilon2)
    ...
    next_dose = et.update(cases, n=10**6)
    assert next_dose == 4
    assert np.all(np.abs(et.prob_eff - np.array([0.05, 0.07, 0.19, 0.38, 0.54])) <= epsilon1)
    ...
    assert np.all(np.abs(et.prob_tox - np.array([0.01, 0.04, 0.20, 0.56, 0.79])) <= epsilon1)
    ...
    assert np.all(np.abs(et.utility - np.array([-0.93, -0.92, -0.95, -1.14, -1.16])) <= epsilon2)
    ...
    assert np.all(np.abs(et.prob_acc_eff - np.array([ 0.02, 0.02, 0.09, 0.34, 0.55])) <= epsilon2)
    ...
    assert np.all(np.abs(et.prob_acc_tox - np.array([0.98, 0.97, 0.75, 0.28, 0.11])) <= epsilon2)
    ...
    next_dose = et.update(cases, n=10**6)
    assert next_dose == 3
    assert np.all(np.abs(et.prob_eff - np.array([0.03, 0.08, 0.26, 0.54, 0.75])) <= epsilon1)
    ...
    assert np.all(np.abs(et.prob_tox - np.array([0.01, 0.04, 0.22, 0.64, 0.89])) <= epsilon1)
    ...
    assert np.all(np.abs(et.utility - np.array([-0.95, -0.91, -0.84, -0.92, -0.89])) <= epsilon2)
    ...
    assert np.all(np.abs(et.prob_acc_eff - np.array([ 0.01, 0.02, 0.16, 0.57, 0.84])) <= epsilon2)
    ...
    assert np.all(np.abs(et.prob_acc_tox - np.array([0.99, 0.97, 0.72, 0.16, 0.02])) <= epsilon2)
